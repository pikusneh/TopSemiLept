...
namespace ROOT {
   static TClass *TopSemiLeptAnalyzer_Dictionary();
   static void TopSemiLeptAnalyzer_TClassManip(TClass*);
   static void delete_TopSemiLeptAnalyzer(void *p);
   static void deleteArray_TopSemiLeptAnalyzer(void *p);
   static void destruct_TopSemiLeptAnalyzer(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TopSemiLeptAnalyzer*)
   {
      ...
      instance.SetDelete(&delete_TopSemiLeptAnalyzer);
      instance.SetDeleteArray(&deleteArray_TopSemiLeptAnalyzer);
      instance.SetDestructor(&destruct_TopSemiLeptAnalyzer);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::TopSemiLeptAnalyzer*)
   {
      return GenerateInitInstanceLocal((::TopSemiLeptAnalyzer*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TopSemiLeptAnalyzer*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *TopSemiLeptAnalyzer_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::TopSemiLeptAnalyzer*)0x0)->GetClass();
      TopSemiLeptAnalyzer_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrapper around operator delete
   static void delete_TopSemiLeptAnalyzer(void *p) {
      delete ((::TopSemiLeptAnalyzer*)p);
   }
   static void deleteArray_TopSemiLeptAnalyzer(void *p) {
      delete [] ((::TopSemiLeptAnalyzer*)p);
   }
   static void destruct_TopSemiLeptAnalyzer(void *p) {
      typedef ::TopSemiLeptAnalyzer current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::TopSemiLeptAnalyzer

...
procflags = {
        ...
        'nrootfiles':4, # set to -1 when you want to process all files in the input dir of root:// type
        }
...
nanoaod_inputdir_outputdir_pairs = [['/TTGamma_Hadronic_TuneCP5_13TeV-madgraph-pythia8/RunIISummer20UL17NanoAODv9-106X_mc2017_realistic_v9-v1/NANOAODSIM','/eos/uscms/store/user/snehshuc/test/2017/TTGamma_Hadronic_pt_gamma100-200_output1.root', 'stderr_TTGamma_Had_ptgamma100-200.out']]

...
nanoaod_inputdir_outputdir_pairs = [['/eos/uscms/store/user/snehshuc/2017/TTGamma', '/eos/uscms/store/user/snehshuc/test/2017/TTGamma_output_100k.root', 'stderr.out']]
